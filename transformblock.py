...
class TransformBlock_Prefill_KVCache(Layer):
    def __init__(self,num_head,hidden_channel,output_channel,cur_layer,use_lora=False,**kwargs):
        ...
        self.attention = AttentionWithRoPE_Prefill_KVCache(self.output_channel,self.num_head,self.cur_layer,name="attention")
        self.ffn = SwiGLU(self.hidden_channel,self.output_channel,use_lora=use_lora,name="swiGLU")
...
class TransformBlock_Decode_KVCache(Layer):
    def __init__(self,num_head,hidden_channel,output_channel,cur_layer,use_lora=False,**kwargs):
        ...
        self.norm_1 = RMSNormalization(name="rmsnorm_1")
        self.norm_2 = RMSNormalization(name="rmsnorm_2")
        self.attention = AttentionWithRoPE_Decode_KVCache(self.output_channel,self.num_head,self.cur_layer,name="attention")
        self.ffn = SwiGLU(self.hidden_channel,self.output_channel,use_lora=use_lora,name="swiGLU")
        # self.supports_masking = True
...
class TransformBlock(Layer):
    def __init__(self,num_head,hidden_channel,output_channel, cur_layer,use_lora=False,**kwargs):
        ...
        self.norm_1 = RMSNormalization(name="rmsnorm_1")
        self.norm_2 = RMSNormalization(name="rmsnorm_2")
        self.attention = AttentionWithRoPE(self.output_channel,self.num_head,cur_layer,name="attention")
        self.ffn = SwiGLU(self.hidden_channel,self.output_channel,use_lora=use_lora,name="swiGLU")
        # self.supports_masking = True
    def call(self,x,mask=None):
        res = x
